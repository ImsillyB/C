...
GLfloat left_light_position[] = {-1.0, 0.0, 1.0, 0.0}, right_light_position[] = {1.0, 0.0, 1.0, 0.0};
...
GLfloat slate_ambient[] = {0.02, 0.02, 0,02}, slate_diffuse[] = {0.02, 0.01, 0,02}, slate_specular[] = {0.4, 0.4, 0.4}, slate_shininess = 0.78125;
